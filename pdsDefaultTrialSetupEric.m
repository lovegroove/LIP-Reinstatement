function dv = pdsDefaultTrialSetupEric(dv)
...
%should probably make rig specfic ones for myself*********
...
%-------------------------------------------------------------------------%
% PsychPort Audio
dv.pref.wavfiles = '/Users/huklab/PLDAPS/RigConfigFiles/wavfiles/'; %filepath for shopRig
dv = pdsAudioSetupNew(dv); % new audio setup - uses audioread  
end

...
% Trial states                                      
 switch state
    case p.trial.pldaps.trialStates.trialSetup
        ...
        p.trial.stimulus.targ1LocPix = p.trial.stimulus.targ1Loc.*p.trial.display.ppd;
...
%             opticflow.screenPlot(p.trial.sf, time, diff(p.trial.timing.flipTimes(1,dataInds)), p.trial.display.clut.hRed, '--');
           ...
           % Drawing fix pt, targets etc.  
             Screen('Drawdots',  p.trial.display.overlayptr, [p.trial.stimulus.targ1LocPix(1) p.trial.stimulus.targ1LocPix(2)], ...
